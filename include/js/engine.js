...
/* JQuery-ui-1.8.9.custom.min END */
...
$(document).ready(function(){
    // $("body").css("display", "none");
     ...
     function redirectPage() {
			window.location = linkLocation+"/#content";
		}*/
     ...
     /* плавное появление контента */
		$("#mainblock").css("opacity", "0.0")
		.animate({opacity: "1"}, 1000)


 	/* подсказка над главным меню */
		...
		/*Ползунок в подвале на менюшках*/
		$("#onas_sl").animate({marginTop: "24px",opacity: "0.4"}, 0)
		$("#diz_sl").animate({marginTop: "24px",opacity: "0.4"}, 0)
		$("#sozs_sl").animate({marginTop: "24px",opacity: "0.4"}, 0)

		$("#onas_1").hover(function() {
			$("#onas_sl").animate({marginTop: "24px",opacity: "1"}, 50);
		});
		$("#onas_2").hover(function() {
			$("#onas_sl").animate({marginTop: "40px",opacity: "1"}, 50)
		});
		$("#onas_3").hover(function() {
			$("#onas_sl").animate({marginTop: "60px",opacity: "1"}, 50)
		});
		$("#onas").hover(function() {
			$("#onas_sl").animate({marginTop: "24px",opacity: "0.4"}, 100)
		});

		$("#diz_1").hover(function() {
			$("#diz_sl").animate({marginTop: "24px",opacity: "1"}, 50);
		});
		$("#diz_2").hover(function() {
			$("#diz_sl").animate({marginTop: "40px",opacity: "1"}, 50)
		});
		$("#diz_3").hover(function() {
			$("#diz_sl").animate({marginTop: "60px",opacity: "1"}, 50)
		});
		$("#diz").hover(function() {
			$("#diz_sl").animate({marginTop: "24px",opacity: "0.4"}, 100)
		});

		$("#sozs_1").hover(function() {
			$("#sozs_sl").animate({marginTop: "24px",opacity: "1"}, 50);
		});
		$("#sozs_2").hover(function() {
			$("#sozs_sl").animate({marginTop: "40px",opacity: "1"}, 50)
		});
		$("#sozs_3").hover(function() {
			$("#sozs_sl").animate({marginTop: "60px",opacity: "1"}, 50)
		});
		$("#sozs_4").hover(function() {
			$("#sozs_sl").animate({marginTop: "80px",opacity: "1"}, 50)
		});
		$("#sozs").hover(function() {
			$("#sozs_sl").animate({marginTop: "24px",opacity: "0.4"}, 100)
		});
...
$(document).ready(function(){
	...
	***********************************************************/
	window.reloadEditApply = function(){
		$("#edit_apply").click( function(href){
			var rndval = new Date().getTime();
			var serialize = $("#iditTarget").serialize();
			$.post("/admin.php/?action=edit_page&rndval="+rndval, serialize, function(data) {
